...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1A0F1C] via-[#2D1030] to-[#1A0F1C] flex items-center justify-center p-4">
      {/* Decorative background elements */}
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 h-96 w-96 rounded-full bg-[#8B1D8F]/20 blur-3xl" />
        <div className="absolute -bottom-40 -left-40 h-96 w-96 rounded-full bg-[#E91E7A]/10 blur-3xl" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[600px] w-[600px] rounded-full bg-[#8B1D8F]/5 blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-[420px]">
        ...
        <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl overflow-hidden">
          ...
          {/* Header strip */}
          <div className="bg-gradient-to-r from-[#8B1D8F] to-[#C2185B] px-8 py-6 text-center">
            ...
            <p className="mt-1 text-[13px] text-white/70">Saheli Shrungar — Secure Access</p>
          </div>
          ...
          <div className="px-8 py-7">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-white/10 bg-white/8 pl-10 pr-4 py-3 text-[14px] text-white placeholder:text-white/30 outline-none focus:border-[#8B1D8F] focus:bg-white/10 transition backdrop-blur-sm"
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-white/10 bg-white/8 pl-10 pr-12 py-3 text-[14px] text-white placeholder:text-white/30 outline-none focus:border-[#8B1D8F] focus:bg-white/10 transition backdrop-blur-sm"
                    style={{ background: "rgba(255,255,255,0.06)" }}
                  />
                  <button
                    type="button"
              ...
              <button
                ...
                disabled={loading}
                className="w-full rounded-xl bg-gradient-to-r from-[#8B1D8F] to-[#C2185B] py-3.5 text-[15px] font-bold text-white transition hover:opacity-90 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed mt-2 shadow-lg shadow-[#8B1D8F]/30"
              >
                {loading ? (
