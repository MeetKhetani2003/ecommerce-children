  ...
  return (
    <div className="mx-auto max-w-[1240px] px-4 py-8 md:py-12">
      ...
      <nav className="mb-8 flex items-center text-[13px] text-[#8B7A8F]">
        <Link to="/" className="hover:text-[#8B1D8F]">Home</Link>
                ...
                <div className="overflow-hidden rounded-[20px] border border-[#F0E6F2] bg-white shadow-sm transition-all duration-300 group-hover:shadow-xl group-hover:shadow-[#8B1D8F]/10">
                  <div className="relative aspect-[4/5] overflow-hidden bg-[#FCF7FD]">
                    ...
                    <button 
                      ...
                      className="absolute right-2.5 top-2.5 grid h-8 w-8 place-items-center rounded-full bg-white/90 text-[#6B5A6F] opacity-0 shadow-sm backdrop-blur transition-all hover:text-[#E91E7A] group-hover:opacity-100"
                    >
                    ...
                    <div className="absolute inset-x-2.5 bottom-2.5 translate-y-2 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
                      <button 
                        ...
                        className="flex w-full items-center justify-center gap-1.5 rounded-xl bg-[#1A0F1C] py-2.5 text-[13px] font-medium text-white shadow-lg shadow-black/20 backdrop-blur-xl transition hover:bg-black"
                      >
